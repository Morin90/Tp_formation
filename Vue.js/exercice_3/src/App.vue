...
export default {
  ...
  methods: {
    ...
    // Ajout d'une méthode voir si connecté ou pas
    Connect(){
    this.showUserNavF == true? this.showUserNavF = false
    :this.showUserNavF==false ? this.showUserNavF = true
    :this.showUserNav
  ...
  <main-layout>
    <template #header>
      <main-nav
        ...
        :showUserNav="showUserNavF"
      />
      <!-- modification de showUserNav en showUserNavF pour lui inclure la variable -->
    </template>
      ...
      <button type="submit" @:click="Connect">Se Connecter</button> <!--ajout du @:clik pour lui dire que quand je clique il utilise la méthode Connect-->
